  ...
  return (
    <section className="relative py-10 md:py-14 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[2500px] px-12">
        <FadeIn>
          <h2 className="font-heading mb-8 md:mb-10 text-[clamp(44px,5vw,100px)] font-bold tracking-[0.02em] text-[#1a1a1a] uppercase leading-tight text-center md:text-left">
            {contact.heading}
          </h2>
        </FadeIn>
